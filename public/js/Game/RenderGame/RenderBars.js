export default async (canvas, game, Listener) => {
    ...
    let healthPercent = state.online ? 0.5-(game.state.musicInfo.health/200)+(game.state.musicInfoOpponent.health/200) : 1-(game.state.musicInfo.health > 100 ? 100 : game.state.musicInfo.health)/100 >= 1 ? 1 : 1-(game.state.musicInfo.health > 100 ? 100 : game.state.musicInfo.health)/100
